...
class ProgressDialog(wx.Frame):
    def __init__(self, parent, title):
        wx.Frame.__init__(self, parent, title=title, size=(768, 576), style=wx.DEFAULT_FRAME_STYLE & ~(
        wx.RESIZE_BORDER | wx.RESIZE_BOX | wx.MAXIMIZE_BOX | wx.CLOSE_BOX) | wx.CAPTION | wx.STAY_ON_TOP)
        self.Centre()
        self.InitUI()
    ...
    def InitUI(self):
        ...
        self.Text0 = wx.StaticText(self.mainPanel, -1, u"Скачивание и применение обновлений...", pos=(0, 10),
                                   size=(450, -1), style=wx.ALIGN_CENTER);
        ...
        self.Text1 = wx.StaticText(self.mainPanel, -1, self.StageText, pos=(0, 50), size=(450, -1),
                                   style=wx.ALIGN_CENTER);
        self.ProcText = wx.StaticText(self.mainPanel, -1, "0%", pos=(0, 70), size=(450, -1),
                                      style=wx.ALIGN_CENTER | wx.TRANSPARENT_WINDOW)
